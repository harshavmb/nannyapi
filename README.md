...
Okay, I can create a `CONTRIBUTORS.md` file with the requested information and update the 

README.md

 file to refer to it.

First, let's create the `CONTRIBUTORS.md` file:
...
README.md
 ...
 file to refer to the `CONTRIBUTORS.md` file:
